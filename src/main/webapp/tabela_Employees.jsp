...
<body>
	...
	<br />
	<p align="center">
		<a href="nou_Employees.jsp" class = "button"><b>Add a new employee.</b></a> <a
			href="index.html" class = "button"><b>Home</b></a>
	</p>
	<form action="sterge_Employees.jsp" method="post">
