...
<link rel="stylesheet" href="style.css">        
    ...
    <body>
        ...
        <br/>
        <p align="center"><a href="nou_HR.jsp" class = "button"><b>Add a new HR.</b></a> <a href="index.html" class = "button"><b>Home</b></a></p>
        <form action="sterge_HR.jsp" method="post">
